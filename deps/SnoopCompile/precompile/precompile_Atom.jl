...
function _precompile_()
    ...
    isdefined(Atom, Symbol("#148#151")) && precompile(Tuple{getfield(Atom, Symbol("#148#151")),Dict{Symbol,Any}})
    ...
    isdefined(Atom, Symbol("#270#272")) && precompile(Tuple{getfield(Atom, Symbol("#270#272")),Dict{Symbol,Any}})
    isdefined(Atom, Symbol("#271#273")) && precompile(Tuple{getfield(Atom, Symbol("#271#273")),Dict{Symbol,Any}})
    isdefined(Atom, Symbol("#274#276")) && precompile(Tuple{getfield(Atom, Symbol("#274#276")),Atom.GotoItem})
    isdefined(Atom, Symbol("#296#298")) && precompile(Tuple{getfield(Atom, Symbol("#296#298")),Dict{Symbol,Any}})
    isdefined(Atom, Symbol("#297#299")) && precompile(Tuple{getfield(Atom, Symbol("#297#299")),Dict{Symbol,Any}})
    ...
    precompile(Tuple{Core.kwftype(typeof(Atom.__collecttoplevelitems)),NamedTuple{(:inmod,),Tuple{Bool}},typeof(Atom.__collecttoplevelitems),Nothing,String})
