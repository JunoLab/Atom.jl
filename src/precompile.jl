...
function _precompile_()
    ...
    @assert precompile(Tuple{typeof(Atom.wsicon),Module,Symbol,Dict{String,NamedTuple{(:f, :m, :tt),Tuple{Any,Method,Type}}}})
    ...
    @assert precompile(Tuple{typeof(isundefined),Dict{String,NamedTuple{(:f, :m, :tt),Tuple{Any,Method,Type}}}})
