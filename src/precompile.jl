...
function _precompile_()
    ...
    try; @assert(Base.precompile(Tuple{Type{Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1},Axes,F,Args} where Args<:Tuple where F where Axes},typeof(Atom.completion),Tuple{Base.RefValue{Module},Array{FuzzyCompletions.Completion,1},Base.RefValue{String}}})); catch err; @debug err; end
    ...
    try; @assert(Base.precompile(Tuple{typeof(Base.Broadcast.materialize),Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1},Nothing,typeof(Atom.completion),Tuple{Base.RefValue{Module},Array{FuzzyCompletions.Completion,1},Base.RefValue{String}}}})); catch err; @debug err; end
    ...
    try; @assert(Base.precompile(Tuple{typeof(include_string),Function,Module,String,String,Int64})); catch err; @debug err; end
