...
function _precompile_()
    ...
    @assert precompile(Tuple{typeof(Atom.wsicon),Module,Symbol,Dict{String,Pair{UInt64,Union{NamedTuple{(:rt, :desc),Tuple{String,String}}, NamedTuple{(:f, :m, :tt),Tuple{Any,Method,Type}}}}}})
    ...
    @assert precompile(Tuple{typeof(isundefined),Dict{String,Pair{UInt64,Union{NamedTuple{(:rt, :desc),Tuple{String,String}}, NamedTuple{(:f, :m, :tt),Tuple{Any,Method,Type}}}}}})
